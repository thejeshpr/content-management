...
- **Investment Type:** Direct Equity (SIP in Stocks)  
- **Strategy:** Diversified portfolio of 10 reliable large-cap and quality mid-cap stocks for long-term compounding  
- **Expected Return:** ~14–16% CAGR  
- **Projected Value in 10 Years:** Around ₹1 Crore  
...
| Energy & Infrastructure | 22% | Stable cyclical exposure |
| Information Technology | 18% | Cash-rich, consistent dividends |
| FMCG & Consumer | 15% | Defensive, steady growth |
| Retail & Discretionary | 15% | High growth potential |
| Cash / Buffer | 10% | For rebalancing or adding new stocks later |

---

## 💡 Investment Tips
- Use SIP mode on platforms like **Groww**, **Zerodha**, or **Dhan** for each stock.  
- Keep the same percentage allocations for the entire 10-year period.  
- Reinvest dividends to maximize compounding returns.  
- Review your portfolio **once a year** and rebalance if required.  
- Stay invested long-term — ignore short-term market volatility.  
- Focus on **consistency, not timing** — SIP discipline builds wealth.
...
- **CAGR Needed:** ~17–18%  
- **Risk Profile:** Moderate to Growth-Oriented  
